...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
      ...
      if (g_pd3dDevice->CreateVertexShader(vertexBuffer, sizeof(vertexBuffer), nullptr, &g_pVertexShader) != S_OK)
        return false;
    ...
    // Create the pixel shader
    {
      ...
      if (g_pd3dDevice->CreatePixelShader(shaderBlob, sizeof(shaderBlob), nullptr, &g_pPixelShader) != S_OK)
        return false;
    }
